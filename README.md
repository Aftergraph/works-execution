...
[![CodeQL](https://github.com/Aftergraph/works-execution/actions/workflows/codeql.yml/badge.svg)](https://github.com/Aftergraph/works-execution/security/code-scanning)

<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset=".github/assets/github/hero.webp">
    <img src=".github/assets/github/hero.png" alt="WORKS — Durable execution plane for autonomous work" width="100%">
  </picture>
</p>
